        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="text-center group" data-aos="fade-up" data-aos-delay="200">
              ...
              <h3 className="text-lg font-bold text-wellness-violet mb-2">Initial Consultation</h3>
              <p className="text-gray-600 text-xs">Understanding your needs, goals, and creating a safe space for open communication.</p>
            </div>
            ...
            <div className="text-center group" data-aos="fade-up" data-aos-delay="400">
              ...
              <h3 className="text-lg font-bold text-wellness-violet mb-2">Personalized Plan</h3>
              <p className="text-gray-600 text-xs">Developing a tailored approach that combines the most effective methods for your situation.</p>
            </div>
            ...
            <div className="text-center group" data-aos="fade-up" data-aos-delay="600">
              ...
              <h3 className="text-lg font-bold text-wellness-violet mb-2">Active Sessions</h3>
              <p className="text-gray-600 text-xs">Regular sessions focused on progress, skill-building, and emotional processing.</p>
            </div>
            ...
            <div className="text-center group" data-aos="fade-up" data-aos-delay="800">
              ...
              <h3 className="text-lg font-bold text-wellness-violet mb-2">Ongoing Support</h3>
              <p className="text-gray-600 text-xs">Continued guidance and resources to maintain progress and prevent setbacks.</p>
            </div>
          </div>
        </div>
      </section>
